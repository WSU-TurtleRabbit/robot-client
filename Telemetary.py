            ...
            try:
                ...
                # except BlockingIOError:
                    ...
                    # if self.latest_data:
                        ...
                        tel_data = await self.do(Action(1, 10, 0, 0 ))
                        ...
                        try:
                            ...
                            # log.info("Data has been sent to %s", ip[0])
                            self.sock_sender.sendto(sender_msg, ("192.168.16.115", self.sending_port))  # Send telemetry
                            log.info("Data has been sent to %s", "")
