...
sudo apt-get install --yes libssl-dev zlib1g-dev libbz2-dev \
                         libreadline-dev libsqlite3-dev llvm \
                         libncurses5-dev libncursesw5-dev \
                         xz-utils tk-dev libgdbm-dev lzma \
                         lzma-dev tcl-dev libxml2-dev libxmlsec1-dev \
                         libffi-dev liblzma-dev wget curl make \
...
sudo apt install --yes python3-pyside2* python3-serial python3-can python3-matplotlib python3-qtconsole
